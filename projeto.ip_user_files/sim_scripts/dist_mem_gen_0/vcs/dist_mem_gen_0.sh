...
design_libs=(dist_mem_gen_v8_0_17 xil_defaultlib)
...
compile()
{
  vlogan -work dist_mem_gen_v8_0_17 $vlogan_opts +v2k +incdir+"../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/tiago/Desktop/projeto/projeto.cache/compile_simlib/vcs"
  fi
